...
const stripe = require('stripe')('** for the key please see readme or contact required person or stripe dashboard');
    ...
    line_items: [
      {
        ...
        price_data: {
          ...
          unit_amount: 100, // takes lowest units that is if Rs20 multiply by 100, same for dollar multiply with 100
        },
        quantity: 1,
      },
    ],
...
// need to created a webhook endpoint in stripe dashboard(simple process) , relevant links to do so given below
//https://dashboard.stripe.com/webhooks
//https://stripe.com/docs/payments/handling-payment-events
//to code and create webhooks : https://stripe.com/docs/api/webhook_endpoints/create


// *** The below code is when you create from this link https://dashboard.stripe.com/webhooks , you can select what events you want , 
//simply create the webhook endpoint from the stripe dashboard and select the relevant options
...
const endpointSecret = "whsec_8896e326a6e63f3c60f15a81f57570f6cda7a6e125e62574fcbf98ca0db1eddb";
